PINS_AF = (
  ...
  ('D5_PWM1', (5, 'GPIO1_PIN10'), ),
  ('D6_PWM2', (1, 'QTIMER3_TIMER2'), (2, 'LPUART2_TX'), (5, 'GPIO1_PIN18'), ),
  ('D7_PWM3', (1, 'QTIMER3_TIMER3'), (2, 'LPUART2_RX'), (5, 'GPIO1_PIN19'), ),
  ('D8', (2, 'LPUART6_RX'), (5, 'GPIO1_PIN3'), ),
  ('D9_PWM4', (2, 'LPUART6_TX'), (5, 'GPIO1_PIN2'), (7, 'LPSPI3_SDI'), ),
  ('D10_SS', (2, 'LPI2C3_SDA'), (5, 'GPIO3_PIN13'), ),
  ...
  ('A0', (2, 'LPUART8_TX'), (5, 'GPIO1_PIN26'), ),
  ('A1', (2, 'LPUART8_RX'), (5, 'GPIO1_PIN27'), ),
  ('A2', (2, 'LPUART3_CTS_B'), (5, 'GPIO1_PIN20'), ),
  ('A3', (2, 'LPUART3_RTS_B'), (5, 'GPIO1_PIN21'), ),
  ('A4', (1, 'QTIMER3_TIMER1'), (2, 'LPUART2_RTS_B'), (3, 'LPI2C1_SDA'), (5, 'GPIO1_PIN17'), ),
  ('A5', (1, 'QTIMER3_TIMER0'), (2, 'LPUART2_CTS_B'), (3, 'LPI2C1_SCL'), (5, 'GPIO1_PIN16'), ),
)
