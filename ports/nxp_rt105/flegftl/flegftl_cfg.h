...
#define FLEG_EU_CNT				20// 16

#define FLEG_LPU_PER_EU			465		// Logic Page Unit per Erase Unit, should hide some for better write access performance
#define FLEG_ADDR0				0
#define FLEG_WB_THRESHOLD		100		// wear balance threshold
#define FLEG_FLASH_OFFSET		0x60800000
// <<<

// >>> below configurations are calcuated based on basic configs, user must calculate correctly!
#define FLEG_CAPACITY		(5120*1024) //(4096*1024) // FLEG_EU_SIZE * FLEG_EU_CNT
#define FLEG_L1BM_ITEM_CNT	1 //4 // must be >= ((FLEG_PGU_CNT + 31) / 32)
