// args= ['./make-pins.py', '--board', './omvrt1/pins.csv', '--af', './mimxrt105x_af.csv', '--pinmap', './mimxrt105x_pinmap.csv', '--prefix', './mimxrt105x_prefix.c', '--hdr', '../build-omvrt1/genhdr/pins.h', '--qstr', '../build-omvrt1/pins_qstr.h', '--af-const', '../build-omvrt1/genhdr/pins_af_const.h', '--af-py', '../build-omvrt1/pins_af.py']
// This file was automatically generated by make-pins.py
//
// --af ./mimxrt105x_af.csv
// --pinmap ./mimxrt105x_pinmap.csv
// --board ./omvrt1/pins.csv
