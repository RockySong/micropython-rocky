...
SUPPORTED_FN = {
    #'GPIO'  : ['PIN'],
    'CT': ['CAP0',  'CAP1',  'CAP2', 'CAP3', 'MAT0',  'MAT1',
               'MAT2', 'MAT3'],
    'I2C' : ['SDA', 'SCL'],
    'I2S'   : ['CK', 'MCK', 'SD', 'WS', 'EXTSD'],
    'UART': ['RXD', 'TXD', 'CTS', 'RTS'],
	'FC'  : ['TXD_SCL_MISO', 'RXD_SDA_MOSI', 'RXD_SDA_MOSI_DATA', 'CTS_SDA_SSEL0',
             'TXD_SCL_MISO_WS', 'RTS_SCL_SSEL1', 'SCK', 'SSEL2', 'SSEL3'],
...
def parse_port_pin(name_str):
    ...
    if name_str[1] < '0' or name_str[1] > '9':
...
def main():
    ...
    if len(sys.argv) < 2:
        sys.argv = ['.\\boards\\make-pins.py', '--board', '.\\boards\\PYBV11\\pins.csv', '--af', '.\\boards\\stm32f405_af.csv', '--prefix', '.\\boards\\stm32f4xx_prefix.c', '--hdr', 'build-PYBV11\\genhdr\\pins.h', '--qstr', 'build-PYBV11\\pins_qstr.h', '--af-const', 'build-PYBV11\\genhdr\\pins_af_const.h', '--af-py', 'build-PYBV11\\pins_af.py']
